...
(/** @lends <global> */function( $ ) {
	...
	function _fnLanguageCompat( oLanguage )
	{
		...
		if ( !oLanguage.sEmptyTable && zeroRecords &&
			oDefaults.sEmptyTable === "Žádná dostupná data" )
		{
		...
		if ( !oLanguage.sLoadingRecords && zeroRecords &&
			oDefaults.sLoadingRecords === "Načítání..." )
		{
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 *    } );
			 */
			"sEmptyTable": "Žádná dostupná data",
			 ...
			 *    } );
			 */
			"sInfo": "Zobrazeno od _START_ do _END_ z _TOTAL_ položek",
			 ...
			 *    } );
			 */
			"sInfoEmpty": "Zobrazeno od 0 do 0 z 0 položek",
			 ...
			 *    } );
			 */
			"sInfoFiltered": "(filtered from _MAX_ total položek)",
			 ...
			 *    } );
			 */
			"sLengthMenu": "Show _MENU_ položek",
